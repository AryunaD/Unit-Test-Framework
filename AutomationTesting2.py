...
class MyTestCase(unittest.TestCase):
    ...
    def test_Register(self):
        ...
        self.driver.find_element_by_xpath("//input[@placeholder='First Name']").send_keys("Aryuna")
        self.driver.implicitly_wait(10)
        self.driver.find_element_by_xpath("//input[@placeholder='Last Name']").send_keys("Dagbaeva")
        self.driver.find_element_by_xpath("/html[1]/body[1]/section[1]/div[1]/div[1]/div[2]/form[1]/div[2]/div[1]/textarea[1]").send_keys("3254 Bogert ave")
        self.driver.implicitly_wait(10)
        self.driver.find_element_by_xpath("/html[1]/body[1]/section[1]/div[1]/div[1]/div[2]/form[1]/div[3]/div[1]/input[1]").send_keys("aryunad132@gmail.com")
        self.driver.implicitly_wait(10)
        self.driver.find_element_by_xpath("/html[1]/body[1]/section[1]/div[1]/div[1]/div[2]/form[1]/div[4]/div[1]/input[1]").send_keys("1237127898")
        ...
        drp2 = Select(year)
        drp2.select_by_visible_text("1985")
        self.driver.implicitly_wait(10)
        month = self.driver.find_element_by_xpath("//select[@placeholder='Month']")
        drp3 = Select(month)
        drp3.select_by_visible_text("June")
        self.driver.implicitly_wait(10)
        day = self.driver.find_element_by_xpath("//select[@id='daybox']")
        drp4 = Select(day)
        drp4.select_by_visible_text("30")
        self.driver.implicitly_wait(10)
        self.driver.find_element_by_xpath("//input[@id='firstpassword']").send_keys("Alana1")
        self.driver.find_element_by_xpath("//input[@id='secondpassword']").send_keys("Alana1")
...
if __name__ == '__main__':
    unittest.main(testRunner=HtmlTestRunner.HTMLTestRunner(output="/Users/CACC/Downloads/"),
                  verbosity=2)